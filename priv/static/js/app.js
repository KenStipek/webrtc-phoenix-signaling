...
require.register("js/app-answer.js", function(exports, require, module) {
"use strict";

});

require.register("js/app-offer.js", function(exports, require, module) {
"use strict";
...
var channel = _socket2.default.channel("call", {});
...
function call() {
    ...
    peerConnection.createOffer(offerOptions).then(function (offer) {
        ...
        channel.push("message", { body: JSON.stringify({ "sdp": peerConnection.localDescription }) });
...
function gotRemoteDescription(description) {
    ...
    }).then(gotLocalDescription).catch(error);
}
...
function call() {
    ...
    var getOffer = function getOffer() {
        return peerConnection.createOffer(offerOptions).then(function (offer) {
            return peerConnection.setLocalDescription(offer);
        }).then(function () {
            channel.push("message", { body: JSON.stringify({ "sdp": peerConnection.localDescription }) });
            console.log("Offer from localPeerConnection: \n" + description.sdp);
